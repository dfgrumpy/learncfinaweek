...
<div class="jumbotron mt-sm-5 p-4" style="padding-top: 100px;">
	<div class="row">
		<div class="col-lg-5 col-md-6">
			<img src="assets/img/logo_white.png" class="float-left m-2 mt-5" alt="logo"/>
		</div>

		<div class="col-lg-7 col-md-6">
			<h1 class="display-2">LEARN COLDFUSION TODAY</h1>
			<p class="lead">
...
<div class="row" style="padding-top: 50px;">
	<div class="col-lg-12">
		<p class="text-center">
		The Learn CF in a Week course is an open source project. All assets and materials supplied by the course can be used by <br>
		anyone who wishes to learn ColdFusion for themselves or wishes to teach others.
		</p>
	</div>
</div>
</cfoutput>